 ...
 * hereAlphaNumeric - ограничение на буквы ина цифры
 * ограичение на id сделано глобально на все маршруты в файле RouteServiceProvider.php */
Route::get('/govsign2/{sign}/{id}', function ($sign, $id){
    return "Номер: " . $sign . ". Регион: " . $id . ".";
})->whereAlpha('sign')->whereNumber('id');
...
/* Мрашрут использующий контроллер*/
...
Route::get('/hello/{id}', [PostController::class, 'hello4'])->where('id', '[1-5]');
